document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById('filterCat')) {
        new Swiper('#filterCat', {
            slidesPerView: 'auto',
            spaceBetween: 10
        });
    }

    if (widthScreen > 991.1) {
        if (document.getElementById('thumbnailSlider')) {
            let thumbnailSlider = new Swiper("#thumbnailSlider", {
                direction: "vertical",
                spaceBetween: 10,
                slidesPerView: 5,
                freeMode: true,
                ...
                navigation: {
                    nextEl: "#thumbnailSlider_next",
                    prevEl: "#thumbnailSlider_prev",
                },
            });
        ...
        if (document.getElementById('productSliderMob')) {
            let thumbnailSlider = new Swiper("#productSliderMob", {
                loop: true,
                pagination: {
                    el: '#productSliderMob .swiper-pagination',
                    clickable: true,
                },
            });
        }

        if (document.getElementById('mobRevProduct')) {
            let thumbnailSlider = new Swiper("#mobRevProduct", {
                spaceBetween: 10,
                slidesPerView: 'auto',
                wrapperClass: 'reviews__body'
            });
        }

        if (document.getElementById('mobSliderProduct')) {
            let thumbnailSlider = new Swiper("#mobSliderProduct", {
                spaceBetween: 16,
                slidesPerView: 'auto',
            });
        }
    ...
    if (document.getElementById('datepickerInp')) {
        new AirDatepicker('#datepickerInp', {
            isMobile: true,
            autoClose: true,
        });
    }
